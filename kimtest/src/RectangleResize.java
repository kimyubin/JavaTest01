...
public void mouseReleased(MouseEvent e)
			...
			public void mouseDragged(MouseEvent e)
			{
				...
				{ 
					...
					tempP.x = endV.get(BoxNum).x + (e.getX() - moveP.x);
					tempP.y = endV.get(BoxNum).y + (e.getY() - moveP.y);
//					tempP = TransPoint.RecToEndPoint(rec);


					endP.move(tempP.x,tempP.y);
					endV.setElementAt(tempP,BoxNum);
				}
				repaint();
			}
			*/